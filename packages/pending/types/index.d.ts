 ...
 */
declare function pending<PromiseReturnType extends any = any, ErrorType extends any = Error>(callback: () => Promise<PromiseReturnType>): Promise<[PromiseReturnType | undefined, ErrorType | undefined]>;
